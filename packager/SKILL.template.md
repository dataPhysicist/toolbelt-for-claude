...
1. **Give them the installer.** It ships WITH this skill: `{{SLUG}}.mcpb` in this
   ...
   fallback: https://github.com/dataPhysicist/toolbelt-for-claude/raw/main/dist/{{SLUG}}.mcpb
