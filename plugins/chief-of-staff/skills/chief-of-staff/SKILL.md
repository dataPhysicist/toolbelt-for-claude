...
1. Use the tools from the "Chief-of-Staff" connector — its tool descriptions are tagged "[Chief-of-Staff]". If a `toolbelt_setup` tool appears instead, ask the user for their Toolbelt API key and call it.
